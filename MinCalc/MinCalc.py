...
def airblastBoost(production): return(round(production*3.24*1.5))

def goliathBoost(production): return(round(production*9*1.5))

def MPDBoost(production): return(round(production*2.25*1.5))
