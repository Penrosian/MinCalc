...
def airblastBoost(production): return(production*3.24*1.5)

def goliathBoost(production): return(production*9*1.5)

def MPDBoost(production): return(production*2.25*1.5)
...
def askVanilla():
    ...
    elif asked == 4: print("You can run", str(int(cryoMixerToThorReact(float(input("How many cryofluid mixers?"))))), "reactors.")
